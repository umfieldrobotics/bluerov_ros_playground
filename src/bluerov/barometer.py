...
class ROVPose(object):
    def __init__(self, atm_pressure, water_density):
        # rospy.loginfo('holi')
        rospy.Subscriber("/mavlink/from", Mavlink, self.data_callback, queue_size = 1)
        # rospy.Subscriber('/mavros/imu/data', Imu, self.imu_callback)
        self.prespub = rospy.Publisher('/BlueROV/pressure',String,queue_size = 1)
        self.prespub2 = rospy.Publisher('/BlueROV/pressure2',String,queue_size = 1)
...
if __name__ == '__main__':
    rospy.init_node('pressure_listener', anonymous=True,log_level=rospy.DEBUG)
